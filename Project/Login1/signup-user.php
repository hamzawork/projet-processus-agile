            ...
            <div class="col-md-4 offset-md-4 form">
                <form action="signup-user.php" method="POST" autocomplete="">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="CNE" placeholder="CNE" required value="<?php echo $CNE ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="link login-link text-center">vous etes déja inscrit? <a href="login-user.php">Se connecter</a></div>
                </form>
            </div>
        </div>
    </div>
