        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form login-form">
                <form action="login-admin.php" method="POST" autocomplete="">
                    <h2 class="text-center"> <img  src="image/admin.png" alt="form"> Administrateur</h2>
                    ...
                    <div class="link forget-pass text-left"><a href="forgot-password-admin.php">Mot de passe oublié?</a></div>
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="login" value="Se connecter">
                    </div>
                    <div class="link login-link text-center"> <a href="signup-admin.php">S'inscrire</a></div>
                </form>
            </div>
        </div>
    </div>
